...
public interface INerdyNodeParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArrow([NotNull] NerdyNodeParser.ArrowContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitGraphop([NotNull] NerdyNodeParser.GraphopContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunccall([NotNull] NerdyNodeParser.FunccallContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="NerdyNodeParser.paramlist"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitParamlist([NotNull] NerdyNodeParser.ParamlistContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="NerdyNodeParser.graphfunc"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitGraphfunc([NotNull] NerdyNodeParser.GraphfuncContext context);
	/// <summary>
